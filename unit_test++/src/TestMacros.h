...
#define TEST_EX(Name, List)                                                              \
    ...
    {                                                                                    \
    public:                                                                              \
        Test##Name() : Test(UNITTEST_TEXT(#Name),                                        \
        UnitTestSuite::GetSuiteName(), UNITTEST_TEXT(__FILE__), __LINE__) {}             \
    private:                                                                             \
...
#define TEST_FIXTURE_EX(Fixture, Name, List)                                             \
    ...
    {                                                                                    \
    public:                                                                              \
        Test##Fixture##Name() : Test(UNITTEST_TEXT(#Name),                               \
        UnitTestSuite::GetSuiteName(), UNITTEST_TEXT(__FILE__), __LINE__) {}             \
    private:                                                                             \
        virtual void RunImpl() const;                                                    \
    ...
    {                                                                                    \
        ...
        {                                                                                \
            ...
            stream << UNITTEST_TEXT("Unhandled exception: ")                             \
                << UnitTest::Strings::Make(e.what());                                    \
        ...
        {                                                                                \
            ...
            {                                                                            \
                UnitTest::CurrentTest::Results()->OnTestFailure(                         \
                    ...
                    UNITTEST_TEXT("Unhandled exception while destroying fixture ")       \
                    UNITTEST_TEXT(#Fixture));                                            \
            }                                                                            \
            else                                                                         \
            {                                                                            \
                UnitTest::CurrentTest::Results()->OnTestFailure(                         \
                    UnitTest::TestDetails(m_details, __LINE__),                          \
                    UNITTEST_TEXT("Unhandled exception while constructing fixture ")     \
                    UNITTEST_TEXT(#Fixture));                                            \
            }                                                                            \
        }                                                                                \
    }                                                                                    \
